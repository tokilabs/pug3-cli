...
var debug = {
	always: Debug("pug3"),
	watched: Debug("pug3:watched"),
	render: Debug("pug3:render"),
};
...
[
	...
	pugOptions[o[1]] = cmdOptions[o[0]] !== undefined ? cmdOptions[o[0]] : pugOptions[o[1]];
});
...
${page.content}`;
		...
		var fn = pugOptions.client ? pug.compileClient(page.extended, pugOptions) : pug.compile(page.extended, pugOptions);
